...
class RasterTypeFactory():
    ...
    def getRasterTypesInfo(self):
        ...
        return [
                {
                    'rasterTypeName': 'TeLEOS-1',
                    'builderName': 'TeleosBuilder',
                    ...
                    'dataSourceFilter': '*_metadata.xml',
                    'supportedUriFilters': [
                                            {
                                                'name': 'Standard',
                                                'allowedProducts': [
                    ...
                    'processingTemplates': [
                                            {
                                                ...
                                                'functionTemplate': 'TeLEOS-1_stretch_pan.rft.xml'
                                            }
                                           ],
                    'bandProperties': [
                                        {
